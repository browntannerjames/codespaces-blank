...
# Lab 02 
# Lab Section: 13
# Worked with Kelly Joyce, Austin Barner 
# your
# comments
# here
...
school_name = "The University of Wyoming"
year = "1886"
print(f"The {school_name} was founded in {year}")
...
print((first_name + space + last_name).title()) 
